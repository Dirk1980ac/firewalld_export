...
do
  ...
  echo "# Adding ports" >>  firewall-setup.sh
  ...
  echo "# Adding services" >>  firewall-setup.sh
...
while read policies
do
  echo "# Deleting $policies" >> firewall-setup.sh
  echo "firewall-cmd --permanent --delete-polixy=$policies" >> firewall-setup.sh
  echo "# Creating policy $policies" >> firewall-setup.sh
  ...
  echo "# Seting ingress-zones" >>  firewall-setup.sh
  ...
  echo "# Setting egress-zones" >>  firewall-setup.sh
  ...
  echo "# Setting target" >>  firewall-setup.sh
